...
class AppFrameNoThread extends FlowPane {
...
public class ThreadingNoThread extends Application {

  @Override
  public void start(Stage primaryStage) throws Exception {

    // Setting the Layout of the Window (Flow Pane)
    AppFrameNoThread root = new AppFrameNoThread();

    // Set the title of the app
    primaryStage.setTitle("Threading No Thread");
